...
var itemlist = {
	...
	weaponbasicstaff = {
		...
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 3, effectscale = 'maf', descript = "+3 Damage, Magic Affinity Scaling"}],
		recipe = '',
		reqs =  null,
		cost = 50,
		type = 'gear',
	...
	weaponnaturestaff = {
		...
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 4, effectscale = "maf", descript = "+4 Damage, Magic Affinity Scaling"},{type = 'onequip', effect = 'health', effectvalue = 25, descript = "+25 Health"},{type = 'onequip', effect = 'maf', effectvalue = 1, descript = "+1 Magic Affinity"}],
		recipe = '',
	...
	weaponcursedsword = {
		...
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 15, effectscale = "maf", descript = "+15 Damage, Magic Affinity Scaling"}, {type = 'passive', effect = 'doubleattack', effectvalue = 20, descript = '20% chance to attack twice'}, {type = 'passive', effect = 'defenseless', descript = "Wielder's armor is useless"}],
		recipe = '',
		reqs = null,
		cost = 800,
		type = 'gear',
...
###---Added by Expansion---### Bubblepot exploration enablers
	...
	divingsuit = {
		...
		effect = [{type = 'onequip', effect = 'end', effectvalue = 10 ,descript = "Endurance +10"}],
		recipe = '',
		reqs = null,
		cost = 200,
		type = 'gear',
