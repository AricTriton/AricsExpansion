...
var itemlist = {
	...
	weaponshortsword = {
		...
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 6, effectscale = "agi", descript = "+9 Damage, Agi Scaling"}, {type = 'incombat', effect = 'passive', effectvalue = 'armorbreaker', descript = "Bypass 8 Armor"}],
		recipe = '',
		reqs = [],
		cost = 500,
		type = 'gear',
