...
var itemlist = {
	...
	###---Added by Expansion---### CyrusLance's items
	armorruneset = {
		code = 'armorruneset',
		name = 'Runic Engraved Armor',
		icon = "res://files/aric_expansion_images/items/armorruneset.png", # Designer Rendrassa
		description = "Aftermarket modified rune armor worn by the enforcers in Umbra, grants wearer enhanced protection, strength and mobility.",
		effect = [{type = 'incombat', effect = 'protection', effectvalue = 50, descript = "50% Protection"},{type = 'incombat', effect = 'armor', effectvalue = 6, descript = "+6 Armor"},{type = 'incombat', effect = 'speed', effectvalue = 2, descript = "+2 Speed"}, {type = 'incombat', effect = 'damage', effectvalue = 2, descript = "+2 Damage"}],
		recipe = '',
		reqs = null,
		cost = 500,
		type = 'gear',
	...
	####----Weapon Series----#### Purpose of this template is to catalogue weapons, feel free to use the template for any new weapon plans.
	####
	####---Beginner Rank - Consists of weapons ranging from 1 to 4 damage with no stat requirement.
	weaponhunterbow = {
		code = 'weaponhunterbow',
		name = 'Hunter Bow',
		icon = "res://files/aric_expansion_images/items/weaponbow.png", # Designer Rendrassa
		description = "Wooden bow designed for hunting wild life.",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 1, effectscale = 'agi', descript = "+1 Damage, Agi Scaling"},{type = 'onequip', effect = 'cour', effectvalue = 5, descript = "Slightly increases Courage (+5)"},{type = 'onequip', effect = 'agi', effectvalue = 1, descript = "+1 Agility"},{type = 'onequip', effect = 'stren', effectvalue = 1, descript = "+1 Strength"}],
		recipe = '',
		reqs =  null,
		cost = 50,
		type = 'gear',
	...
	weapongoblinspear = {
		code = 'weapongoblinspear',
		name = 'Goblin Handcraft Spear',
		icon = "res://files/aric_expansion_images/items/weapongoblinspear.png", # Designer Rendrassa
		description = "Crude handmade spear created by goblins for hunting.",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 1, effectscale = 'agi', descript = "+1 Damage, Agi Scaling"},{type = 'onequip', effect = 'cour', effectvalue = 5, descript = "Slightly increases Courage (+5)"},{type = 'onequip', effect = 'agi', effectvalue = 1, descript = "+1 Agility"},{type = 'onequip', effect = 'stren', effectvalue = 1, descript = "+1 Strength"}],
		recipe = '',
		reqs =  null,
		cost = 50,
	...
	####
	####---Intermediate Rank - Consists of weapons from 5 to 8 damage.
	weaponbattleaxe = {
		code = 'weaponbattleaxe',
		name = 'Battle Axe',
		icon = "res://files/aric_expansion_images/items/weaponbattleaxe.png", 
		description = "An unwieldy axe made for war. \n[color=yellow]Requirements: 2 Strength[/color]",
	...
	weaponlongbow = {
		code = 'weaponlongbow',
		name = 'Long Bow',
		icon = "res://files/aric_expansion_images/items/weaponlongbow.png", 
		description = "A large bow crafted for battle. \n[color=yellow]Requirements: 2 Agility[/color]",
	...
	weapongoldbow = {
		code = 'weapongoldbow',
		name = 'Regal Bow',
		icon = "res://files/aric_expansion_images/items/weapongoldbow.png", # Designer Rendrassa
		description = "Luxurious designed bow for the rich, the frame work is coated gold with excellent craftmanship. \n[color=yellow]Requirements: 2 Agility[/color]",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 7, effectscale = 'agi', descript = "+7 Damage, Agi Scaling"},{type = 'onequip', effect = 'luxury', effectvalue = 10, descript = "Increases Luxury (+10)"}],
		recipe = '',
		reqs = [{reqstat = 'sagi', oper = 'gte', reqvalue = 2}], 
		cost = 750,
		type = 'gear',
	...
	weaponmagusstaff = {
		code = 'weaponmagusstaff',
		name = 'Magus Staff',
		icon = "res://files/aric_expansion_images/items/weaponmagusstaff.png", # Designer Rendrassa
		description = "Mass product staff commonly used by the mages of Wimborn. \n[color=yellow]Requirements: 2 Magic Affinity[/color] ",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 4, effectscale = 'maf', descript = "+4 Damage, Magic Aff Scaling"},{type = 'onequip', effect = 'wit', effectvalue = 15, descript = "Increases Wit (+15)"},{type = 'onequip', effect = 'maf', effectvalue = 1, descript = "+1 Magic Affinity"},{type = 'passive', effect = 'rank1spelldamage', descript = "Spell Damage +10%"}],
		recipe = '',
		reqs =  [{reqstat = 'smaf', oper = 'gte', reqvalue = 2}],
		cost = 200,
		type = 'gear',
		subtype = 'weapon',
		weight = 3,
	...
	weaponmace = {
		code = 'weaponmace',
		name = "Steel Mace",
		icon = "res://files/aric_expansion_images/items/weapontaurusmace.png", # Designer Rendrassa
		description = "Heavy steel mace designed to deal with armored targets. \n[color=yellow]Requirements: 2 Strength[/color] ",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 6, effectscale = "str", descript = "+6 Damage, Str Scaling"},{type = 'incombatphyattack', effect = 'protpenetration', effectvalue = 1, descript = 'Ignores protection'},{type = 'incombat', id = 'weaponspeed', effect = 'speed', effectvalue = -2, descript = "-2 speed"}],
		recipe = '',
		reqs = [{reqstat = 'sstr', oper = 'gte', reqvalue = 2}],
		cost = 350,
		type = 'gear',
	...
	####
	####---Advance Rank - Consists of weapons from 9 damage and over, best of the best.
	weapondraconiclance = {
		code = 'weapondraconiclance',
		name = 'Draconic Lance',
		icon = "res://files/aric_expansion_images/items/weapondragonkinspear.png", # Designer Rendrassa
		description = "Lance infused with draconic energy, rejuvenates wielder in battle.\n[color=yellow]Requirements: 2 Strength and 2 Endurance[/color] ",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 10, effectscale = 'str', descript = "+10 Damage, Str Scaling"},{type = 'passive', effect = 'rejuvenate', descript = "Regains 15 health per attack"}],
		recipe = '',
		reqs = [{reqstat = 'sstr', oper = 'gte', reqvalue = 2},{reqstat = 'send', oper = 'gte', reqvalue = 2}],
		cost = 1000,
		type = 'gear',
	...
	###---Added by Expansion---### ElPresidente Items & Adjustments CyrusLance
	weaponclaymore = {
		code = 'weaponclaymore',
		name = 'Claymore',
	...
	weaponrunesword = {
		...
		description = "A sword made for an ancient order of spellblades that is engraved with runes that help focus magical power. These weapons are now hard to find and unusable by anyone without some magical affinity.\n[color=yellow]Requirements: 4 Magic Affinity[/color]",
		effect = [{type = 'incombat', effect = 'damage', effectvalue = 9, effectscale = 'maf', descript = "+9 Damage, Maf Scaling"}, {type = 'onequip', effect = 'maf', effectvalue = 1, descript = "+1 Magic Affinity"}],
		recipe = '',
		reqs = [{reqstat = 'smaf', oper = 'gte', reqvalue = 4}],
		cost = 550,
		type = 'gear',
		subtype = 'weapon',
		weight = 4,
	...
	accbooklife = {
		...
		effect = [{type = 'incombat', effect = 'protection', effectvalue = 10, descript = "10% Protection"},{type = 'onequip', effect = 'end', effectvalue = 1, descript = "+1 Endurance"}],
		recipe = '',
		reqs = null,
		cost = 800,
		type = 'gear',
	...
	weaponnaturestaff = {
        ...
        effect = [{type = 'incombat', effect = 'damage', effectvalue = 4, effectscale = "maf", descript = "+4 Damage, Magic Aff Scaling"},{type = 'onequip', effect = 'health', effectvalue = 25, descript = "+25 Health"},{type = 'onequip', effect = 'maf', effectvalue = 1, descript = "+1 Magic Affinity"},{type = 'passive', effect = 'rank2spelldamage', descript = "Spell Damage +20%"}],
        recipe = '',
	...
	weaponcursedsword = {
        ...
        effect = [{type = 'incombat', effect = 'damage', effectvalue = 15, effectscale = "maf", descript = "+15 Damage, Magic Aff Scaling"},{type = 'incombatphyattack', effect = 'protpenetration', effectvalue = 1, descript = 'Ignores protection'},{type = 'passive', effect = 'doubleattack', effectvalue = 20, descript = '20% chance to attack twice'}, {type = 'passive', effect = 'defenseless', descript = "Wielder's armor is useless"}],
        recipe = '',
        reqs = null,
        cost = 800,
        type = 'gear',
