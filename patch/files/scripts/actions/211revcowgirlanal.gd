...
func getname(state = null):
	return "Rev Cowgirl Anal"

func getongoingname(givers, takers):
	return "[name1] ride[s/1] [name2] anally in the reverse cowgirl position."
...
start_7_fsexv = {
	...
	lines = [
		", {^shift:move:raise}[s/1] [his2] {^hips:[body2]} to give [himself1] better access for [his1] [anus1]. ",
	]},
...
main_7_fsexv = {
	...
	lines = [
		"[names1] [anus1] {^envelop:spread apart for:swallow} [names2] [penis2] as ",
	]},
	...
	lines = [
		"[names1] [anus1] {^slide along:coil around:tug at} [names2] [penis2] as ",
	]},
...
main_8_fsexv = {
	...
	lines = [
		...
		"[name1] {^plunge:thrust:screw:slam:grind}[s/1] {^[himself1]:[his1] [anus1]} on [name2]",
...
react_9_fsexv = {
	...
	lines = [
		" as [names2] [penis2] {^fill[s/#2]:slide[s/#2] in and out of} [his1] [anus1].",
		" as [names2] [penis2] {^massage[s/#2]:scrape[s/#2] against:rub[s/#2] against} the walls of [his1] [anus1].",
	]},
