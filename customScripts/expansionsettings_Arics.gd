...
var mage_mana_reduction = [true, "-50% mana cost of spells\nCombat spell deal 20% more damage"]		# Ralph's - [false, "Combat spell deal 20% more damage"]

#Spellcost Changes
var spellcost = 1 					# Ralph's - 2, This is a multiplicative that applies to all spellcosts.
var mindread_manacost = 3			# Ralph's - 1
var sedation_manacost = 10			# Ralph's - 20
var dream_manacost = 20				# Ralph's - 5
var entrancement_manacost = 15		# Ralph's - 10
var fear_manacost = 10				# Ralph's - 20
var mutate_manacost = 15			# Ralph's - 10
var invigorate_manacost = 5			# Ralph's - 20
var summontentacle_manacost = 35	# Ralph's - 20
...
var food_market_cost = 10			# Ralph's = 40

var func_forage_tweaks = [4,20,25,1.2,5]		# Ralph's - [3,2,5,1.5,2]
...
var func_hunt_tweaks = [2,5,10,1.3,1.25,30,40,7]# Ralph's - [1,3,8,1.4,1.5,3,5,3]
