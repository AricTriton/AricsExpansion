...
func addConstantsSupport():
	...
	variables.list["AE Mod - Mkzd' Combat Tweaks"] = {
		...
		disable_levelup_gate = {descript = "'Unlocking potential' becomes not necessary for leveling slaves up.\nInstead fulfilling slave's request gives a boost to XP.", object = self},
	}
