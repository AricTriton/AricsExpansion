...
###---Added by Expansion---### CyrusLance's combat spells
	arcanebolt = {
		code = 'arcanebolt',
		name = 'Arcane Bolt',
		description = "Entry level combat spell taught to aspiring mage, This spell is know for it mana efficient and able to cast rapidly on short notice. \nDeals spell damage to single target enemy. ",
		effect = '',
		manacost = 0,
		req = 1,
		price = 50,
	...
	astralpoison = {
		code = 'astralpoison',
		name = 'Astral Poison',
		description = "Conjure corrupting mana to shroud targeted area cursing all who linger with in. \nCurse enemies saping their strength. ",
		effect = '',
		manacost = 15,
		req = 2,
		price = 150,
	...
	nova = {
		code = 'nova',
		name = 'Nova',
		description = "One of the strongest spells know to mankind, creates mana distortion - sundering all caught in the rift. \nDeals powerful spell damage to all enemies. ",
		effect = '',
		manacost = 50,
		req = 2,
		price = 500,
