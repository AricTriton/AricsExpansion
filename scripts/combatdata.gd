...
var enemypool = {
	...
	rattlesnake = {#poison
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 80, power = 30, speed = 50, energy = 50, armor = 1, magic = 0, abilities = ['attack','poisonstrike'], passives = ['doubleattack25']},
		skills = [],
	},
	desertcentaur = {
		name = 'Desert Centaur',
	...
	shark = {#dps
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 80, power = 30, speed = 50, energy = 50, armor = 1, magic = 0, abilities = ['attack'], passives = ['doubleattack25']},
		skills = [],
	},
	greatwhiteshark = {#nuke
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 100, power = 50, speed = 45, energy = 50, armor = 1, magic = 0, abilities = ['attack'], passives = ['doubleattack25']},
		skills = [],
	},
	orca = {#tank
		name = 'Orca',
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 200, power = 60, speed = 60, energy = 50, armor = 1, magic = 0, abilities = ['attack'], passives = ['doubleattack50']},
		skills = [],
	},
	giantsquid = {#aoe attacker
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 600, power = 100, speed = 60, energy = 50, armor = 1, magic = 0, abilities = ['attack'], passives = ['doubleattack50,aoeattack']},
		skills = [],
	},
	...
	scylla = {#Powerhouse/Capture
		...
		rewardgold = [5,20],
		rewardexp = 30,
		stats = {health = 500, power = 80, speed = 50, energy = 100, armor = 7, magic = 3, abilities = ['attack','stunattack']},
		gear = 'medbandits',
		skills = [],
	},
	drowned = {#Trapper
	...
	poisontoad = {
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 90, power = 25, speed = 25, energy = 50, armor = 1, magic = 0, abilities = ['attack','poisonstrike'], passives = ['doubleattack25']},
		skills = [],
	},
	poisonouslash = {
		name = 'Poisonous Lash',
	...
	eagle = {
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 100, power = 30, speed = 35, energy = 50, armor = 0, magic = 0, abilities = ['attack','aimedstrike'], passives = ['doubleattack25']},
		skills = [],
	},
	skyharpy = {
		name = 'Harpy',
	...
	wyvern = {
		...
		rewardgold = 0,
		rewardexp = 20,
		stats = {health = 800, power = 70, speed = 50, energy = 50, armor = 0, magic = 0, abilities = ['attack','aimedstrike','heavystike'], passives = ['doubleattack25']},
		skills = [],
	},
	#The Beyond
	unknownbird = {
