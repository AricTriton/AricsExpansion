...
var database = {
	...
	marsh = {
		...
		enemies = [{value = 'banditcamp',weight = 1},{value = 'monstergirl', weight = 1}, {value = 'oozesgroup', weight = 2}, {value = 'solospider', weight = 5},{value = 'treasurechest', weight = 1},{value = 'noenemyencountered', weight = 6}], #ralphD - added nonenemyencounters
		encounters = [],
		length = 6,
