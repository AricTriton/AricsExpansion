...
var database = {
	...
	deephole = {
		...
		code = 'deephole',
		name = 'Deep Hole',
		description = "There appears to be a fairly large hole in the ground. It would be fairly unremarkable if not for powerful aura of magic it exudes. It is pitch black within, with no bottom in sight. ",
		enemies = [{value = 'noenemyencountered', weight = 6}], #ralphD - added nonenemyencounters
		encounters = [],
		length = 1,
		exits = ['poisonswamp'],
