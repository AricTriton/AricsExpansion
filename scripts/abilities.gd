...
var abilitydict = {
	...
	deadlyblow = {
		name = 'Deadly Blow',
		code = 'deadlyblow',
		iconnorm = load("res://files/aric_expansion_images/skill_icons/DeadlyStrike.png"),
		iconpressed = load("res://files/aric_expansion_images/skill_icons/DeadlyStrike3.png"),
		icondisabled = load("res://files/aric_expansion_images/skill_icons/DeadlyStrike2.png"),
		learnable = true,
...
####---Added by Expansion---#### CyrusLance's combat spells
	arcanebolt = {
		name = 'Arcane Bolt',
		code = 'arcanebolt',
		iconnorm = load("res://files/aric_expansion_images/skill_icons/Arcanebolt.png"),
		iconpressed = load("res://files/aric_expansion_images/skill_icons/Arcanebolt2.png"),
		icondisabled =load("res://files/aric_expansion_images/skill_icons/Arcanebolt3.png"),
		learnable = true,
		description = "Quick cast spell deals damage to a selected target, scales with Magic Affinity. ",
		usetext = '$name [color=aqua]uses Arcane Bolt[/color] at $targetname. ',
		target = 'one',
		targetgroup = 'enemy',
		effect = null,
		can_miss = false,
	...
	astralpoison = {
		name = 'Astral Poison',
		code = 'astralpoison',
		iconnorm = load("res://files/aric_expansion_images/skill_icons/Astralpoison.png"),
		iconpressed = load("res://files/aric_expansion_images/skill_icons/Astralpoison2.png"),
		icondisabled =load("res://files/aric_expansion_images/skill_icons/Astralpoison3.png"),
		learnable = true,
		description = "Envelop enemies with corrupting mana inflicting curse upon them, scales with Magic Affinity. ",
		usetext = '$name [color=aqua]uses Astral Poison[/color] shrouding the enemies on battlefield. ',
		target = 'all',
		targetgroup = 'enemy',
		effect = 'curseeffectatk',
		can_miss = false,
		learncost = 50,
		power = 0.9,
		cooldown = 3,
	...
	nova = {
		name = 'Nova',
		code = 'nova',
		iconnorm = load("res://files/aric_expansion_images/skill_icons/Nova.png"),
		iconpressed = load("res://files/aric_expansion_images/skill_icons/Nova2.png"),
		icondisabled =load("res://files/aric_expansion_images/skill_icons/Nova3.png"),
		learnable = true,
		description = "Attack all enemies with powerful magic, scales with Magic Affinity. ",
		usetext = '$name [color=aqua]uses Nova[/color]. ',
		target = 'all',
		targetgroup = 'enemy',
		effect = null,
		can_miss = false,
...
func restorehealth(caster, target):
	...
	text = '$name restores {value} health.'.format([value])
	return text
